...
from content.application.infra.instruments.InstrumentsConfig import get_instrument_index_by_name, get_instrument_name_by_index
...
def get_tuning_notes_by_index(index):
    json_data = afinacao_json()

    afinacoes = json_data["afinacoes"][index]["notas"]
...
def edit_tuning_json(index, description, notes, instrument):
    json_data = afinacao_json()

    afinacao = json_data["afinacoes"][index]
    afinacao["afinacao_descricao"] = description
    afinacao["afinacao_instrumento"] = get_instrument_index_by_name(instrument)
    afinacao["notas"] = notes
...
def get_tuning_by_id(index):
    data = afinacao_json()

    return data["afinacoes"][index]
